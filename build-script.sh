...
INTERFACEVIEW=plex-pose_visualisation_iv.aadl
grep "version => \"2" plex-pose_visualisation_iv.aadl >/dev/null && {
    echo -e "${INFO} Converting interface view from V2 to V1.3"
    TASTE --load-interface-view plex-pose_visualisation_iv.aadl --export-interface-view-to-1_3 __iv_1_3.aadl
