...
#include "vizkit3drobotpose.h"

/* Function static data is declared in this file : */
#include "Context-vizkit3drobotpose.h"
...
void vizkit3drobotpose_startup()
{
    int result;
    ...
    result = initializeVizkitOnce(vizkit3drobotpose_ctxt.configfile);
...
void vizkit3drobotpose_PI_updateRigidBodyState(const asn1SccBase_samples_RigidBodyState *IN_state)
{
    int result;
    ...
    if (g_statusOk)
    {
        ...
        result = RigidBodyStateVisualization_updateRigidBodyState(vizkit3drobotpose_ctxt.id, rbs);
