...
void vizkit3dmarkerpose_startup()
{
    int result;
    ...
    result = initializeVizkitOnce(vizkit3dmarkerpose_ctxt.configfile);
...
void vizkit3dmarkerpose_PI_updateRigidBodyState(const asn1SccBase_samples_RigidBodyState *IN_state)
{
    int result;
    ...
    if (g_statusOk)
    {
        ...
        result = RigidBodyStateVisualization_updateRigidBodyState(vizkit3dmarkerpose_ctxt.id, rbs);
